...
public class CopyOfFogCluster201801180530pm {

	private String[] lines = null;
	private Integer points[][] = null;
	private double[][] proximityMatrix = null;
	private int clusterNumber = 100; // Defines number of clusters to generate.
	 ...
	 * Constructor
	 */
	public CopyOfFogCluster201801180530pm(String fn) {
		super();
		csvInput(fn);
		calcProximity();
		learn();		
	...
	public static void main(String[] args) {
		...
		String fileName = new String("C:\\Users\\szs0117\\workspace\\tia\\src\\KMCluster\\LocData-L1-500");
		new CopyOfFogCluster201801180530pm(fileName);
